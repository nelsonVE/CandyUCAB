  ...
  <div class="row pt-5 pb-5">
    ...
    <div class="col-lg-3 col-md-4 pt-4">
      <div class="card">
        ...
        <div class="card-body">
          <h4 class="card-title"><a>{{ $productos[$disponible['fk_car']]->nombre_car }}</a></h4>
          <p class="card-text">
        ...
        <button type="button" class="btn btn-pink" onclick="window.location='/panel/tienda/candy/agregar/{{ $disponible['fk_car'] }}';">Agregar al carrito</button>
      </div>
    </div>
    @endforeach
  </div>
