            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="productoSubmenu">
                        <li>
                            <a href="<?php echo e(url('/admin/producto/crear')); ?>">Crear producto</a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('/admin/productos')); ?>">Lista de productos</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="clienteSubmenu">
                        <li>
                            <a href="<?php echo e(url('/admin/cliente/crear')); ?>">Crear cliente</a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('/admin/clientes')); ?>">Lista de clientes</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="usuariosSubmenu">
                        <li>
                            <a href="<?php echo e(url('/admin/usuario/crear')); ?>">Crear usuario</a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('/admin/usuarios')); ?>">Lista de usuarios</a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('/admin/roles')); ?>">Administrar roles</a>
                        </li>
                    </ul>
                </li>
                <?php if(checkPermiso($rol, 4)): ?>
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="diarioSubmenu">
                        <li>
                            <a href="<?php echo e(url('/admin/diario/ofertas')); ?>">Ver oferta</a>
                        </li>
                        <li>
